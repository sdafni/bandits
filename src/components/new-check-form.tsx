  ...
  return (
    <form action={action} className="space-y-6">
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <label className="space-y-2">
          <span className="text-sm font-medium text-slate-700">Monthly rent (EUR)</span>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <label className="space-y-2">
          <span className="text-sm font-medium text-slate-700">Applicant full name</span>
          <input className="input" name="tenant_full_name" placeholder="Maria Papadopoulou" required />
        </label>
        <label className="space-y-2">
          <span className="text-sm font-medium text-slate-700">Applicant email</span>
          <input className="input" name="tenant_email" placeholder="maria@example.com" type="email" />
        </label>
      </div>

      <label className="space-y-2">
        <span className="text-sm font-medium text-slate-700">Applicant phone</span>
        <input className="input" name="tenant_phone" placeholder="+30 69..." />
      </label>

      <fieldset className="space-y-3">
        <legend className="text-sm font-medium text-slate-700">Requested screening documents</legend>
